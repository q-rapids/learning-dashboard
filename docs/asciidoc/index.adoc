...
operation::students/historical[snippets='path-parameters,request-parameters,curl-request,response-fields,http-response']
...
operation::updates/last[snippets='path-parameters,curl-request,response-fields,http-response']
