...
public interface AlertRepository extends JpaRepository<Alert, Long> {
    ...
    Alert findAlertByProjectIdAndAffectedIdAndValueAndTypeAndPredictionTechniqueAndPredictionDateAndDateGreaterThanEqualAndDateLessThanAndThreshold(
            Long projectId, String affectedId, float value, AlertType type, String technique, Date predictionDate, Date startDayDate, Date nowDate, Float threshold);
